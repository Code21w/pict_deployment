// components/PlanCheck/PlanCheckDay.tsx

function PlanCheckDay() {
  return (
    <div className='absolute top-0 left-[120px] right-0 bottom-0  '>
      <div className='w-[400px] h-full bg-white border-2 border-gray-300 p-4 overflow-auto'>
